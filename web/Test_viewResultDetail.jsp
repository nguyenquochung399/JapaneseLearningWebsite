<%-- 
    Document   : Test_viewResultDetail
    Created on : Dec 1, 2022, 12:43:24 AM
    Author     : Saing
--%>
    ...
    <body>
        ...
        <main id="main">
            ...
            <section id="breadcrumbs" class="breadcrumbs bg-light">
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 style="display: inline-block;">Chi Tiết Đáp Án</h2>                            
                        </div>

                        <ol>                                                       
                            <li><a href="<%= request.getContextPath()%>/HomeControl">Trang Chủ</a></li>
                            <li><a href="viewHistoryTest">Lịch Sử Kiểm Tra</a></li>
                            <li>Chi Tiết Đáp Án</li>
                        </ol>
                    </div>
            ...
            <section id="services" class="services" style="background: #fff">
                ...
                <a href="viewHistoryTest" class="btn btn-outline-danger" tabindex="-1" role="button">
