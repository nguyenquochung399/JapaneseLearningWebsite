<%-- 
    ...
    Created on : Oct 12, 2022, 12:03:45 AM
    Author     : Saing
--%>
...
<!--                                <div class="col-sm-6">
                                ...
                                <tbody>
                                    <c:forEach items="${listQuestion}" var="o" varStatus="i">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="questionEdit?questionID=${o.questionID}" class="btn btn-secondary" tabindex="-1" role="button">Cập Nhật</a>
                                                <a class="btn btn-danger" tabindex="-1" role="button" onclick="showMess(${o.questionID})">Xoá</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                    ...
                    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="${pageContext.request.contextPath}/questionCreate" method="post">
        ...
        <script type="text/javascript">
                                                    ...
                                                    function showMess(ID) {
                                                        ...
                                                        if (option === true) {
                                                            window.location.href = 'questionDelete?questionID=' + ID;
                                                        }
                                                    }
        </script>
    </body>
