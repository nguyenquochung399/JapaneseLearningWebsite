<%-- 
    Document   : editTest
    Created on : Oct 12, 2022, 12:10:06 AM
    Author     : Saing
--%>
                        ...
                        <div class="container">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>Cập Nhật <b>Bài Kiểm Tra</b></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="editEmployeeModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="${pageContext.request.contextPath}/testEdit" method="post">                         
                                        <div class="modal-header">                      
                                            <h4 class="modal-title">Cập Nhật Bài Kiểm Tra</h4>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            <a href="testControl" class="btn btn-default" tabindex="-1" role="button">Hủy</a>
