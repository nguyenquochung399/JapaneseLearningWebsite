<%-- 
    ...
    Created on : Oct 12, 2022, 12:04:15 AM
    Author     : Saing
--%>
                        ...
                        <div id="editEmployeeModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="${pageContext.request.contextPath}/questionEdit" method="post">                         
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="listlevel">
                                                    <c:forEach items="${listlevel}" var="o">
                                                        <option value="${o.levelID}" ${o.levelID == question.levelID?"selected":""}>${olevelName}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <div class="form-group">
