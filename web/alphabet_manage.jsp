...
<html lang="vi">
    ...
    <head>
        ...
        <title>Quản Lí Bảng Chữ Cái</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Quản Lí Bảng Chữ Cái</h2>
                                </div>
                                <div class="col-sm-6">
                                    <a href="#addAlphabet" class="btn btn-success" data-toggle="modal" data-target="#addAlphabet" style="margin-left: 450px; background-color: #000000; border-color: #000000;"><span>Tạo Chữ Cái</span></a>                                             
                                </div>
                            </div>
                        </div>
                        <br>
