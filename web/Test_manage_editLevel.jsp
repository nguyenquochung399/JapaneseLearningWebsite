<%-- 
    Document   : editLevel
    Created on : Oct 12, 2022, 12:01:58 AM
    Author     : Saing
--%>
                             ...
                             <div id="editEmployeeModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="${pageContext.request.contextPath}/leveEdit" method="post">                        
                                            <div class="modal-header">                      
                                                <h4 class="modal-title">Cập Nhật Mức độ</h4>
                                            </div>
                                            <div class="modal-body">    
                                                <div class="form-group">
                                                    <label>Mức độ:</label>
                                                    <input type="text" name="desc" value="${level.levelName}" class="form-control" required>
                                                </div>   
                                            </div>
                                            <div class="modal-footer">
                                                <a href="levelControl" class="btn btn-default" tabindex="-1" role="button">Hủy</a>
