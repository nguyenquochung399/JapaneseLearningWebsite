<%-- 
    Document   : editAnswer
    Created on : Oct 11, 2022, 11:57:57 PM
    Author     : Saing
--%>
                        ...
                        <div id="editEmployeeModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="${pageContext.request.contextPath}/answerEdit" method="post">                         
                                        ...
                                        <div class="modal-body">    
                                            <div class="form-group">
                                                <label>Câu hỏi:</label>
                                                <input type="text" name="Question" value="${ques.question}" class="form-control" required>
                                            </div>                            
                                            <div class="form-group">
                                        ...
                                        <div class="modal-footer">
                                            <a href="answerControl" class="btn btn-default" tabindex="-1" role="button">Hủy</a>
