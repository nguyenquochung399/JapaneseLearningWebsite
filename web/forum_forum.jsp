<%-- 
    Document   : forum_forum
    Created on : Nov 24, 2022, 9:58:28 PM
    Author     : ACER
--%>
    ...
    <body>
        ...
        <main id="main" class="bg-light">
            ...
            <div class="container">
                ...
                <%
                    //ResultSet rs = (ResultSet) session.getAttribute("allPost");
                    //while (rs.next()) {
                    List<ForumAllPostWithComment> f = (List<ForumAllPostWithComment>) session.getAttribute("allPost");
                    for (int i = 0; i < f.size(); i++) {                        
                        
                %>
                <div onclick="location.href = '<%= request.getContextPath()%>/Post/<%= f.get(i).getPost_id()%>';" style="cursor: pointer;">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <%            
                            ...
                            String path = (String) session.getAttribute("currentUrl");
                        ...
                        <li>
                            <button type="submit" form="myformPage" value="Send" class="page-link">Đi Tới</button>
                        </li>
                        <%
                            if (currentPageInt >= totalPage) {
                        %>
                        <li class="page-item disabled">
                            <a class="page-link" href="<%= request.getContextPath()%>/Forum/2">Trang Sau</a>
                        </li>
                        <%
                        } else {
                        %>
                        ...
                        <%    
                            ...
                            String[] s = path.split("/");
                            String currentPage = s[s.length - 1];
                        ...
                        %>
                        <li class="page-item">
                            <a class="page-link" href="<%= request.getContextPath()%>/Forum" tabindex="-1">Trang Trước</a>
                        </li>
                        <li class="page-item">
                            <div class="input-group">
                                <form id="myformPage" onsubmit="window.location = '<%= request.getContextPath()%>/Forum/' + search.value; return false;">
                        ...
                        %>
                        <li class="page-item">
                            <a class="page-link" href="<%= request.getContextPath()%>/Forum/<%= previousPage%>" tabindex="-1">Trang Trước</a>
                        </li>
                        <li class="page-item">
                            <div class="input-group">
                                <form id="myformPage" onsubmit="window.location = '<%= request.getContextPath()%>/Forum/' + search.value; return false;">
