<%-- 
    Document   : detailTag
    Created on : Oct 12, 2022, 12:08:22 AM
    Author     : Saing
--%>
    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Quản Lí Bảng Thể Loại Của Bài Kiểm Tra</h2>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <br>
                        <form action="${pageContext.request.contextPath}/tagDetail" method="POST">
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    <c:forEach items="${listTag}" var="o" varStatus="i">
                                        <tr>
                                            <td>${i.index+1}</td>
                                            <td>${o.desc}</td>
                                            <td>
                                                <a class="btn btn-secondary" tabindex="-1" role="button" href="tagEdit?tagID=${o.tagID}">Cập Nhật</a>
                                                <a class="btn btn-danger" tabindex="-1" role="button" onclick="showMess(${o.tagID})">Xoá</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                <tfoot>
                            ...
                            <a href="tagCreate">Create student</a>
                        </form> 
                    </div>
                    ...
                    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="${pageContext.request.contextPath}/tagCreate" method="post">
        ...
        <script type="text/javascript">
                                                    ...
                                                    function showMess(ID) {
                                                        ...
                                                        if (option === true) {
                                                            window.location.href = '${pageContext.request.contextPath}/tagDelete?tagID=' + ID;
                                                        }
                                                    }
                                                    ;
        </script>
