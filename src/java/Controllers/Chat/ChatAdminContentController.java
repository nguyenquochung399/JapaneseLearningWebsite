 ...
 * @author Admin
 */
public class ChatAdminContentController extends HttpServlet {
                            ...
                            if (i > 0 && i < cmList.size() - 1) {
                                ...
                                if ((cmList.get(i).getUserID() != cmList.get(i + 1).getUserID()) && (cmList.get(i).getUserID() != cmList.get(i - 1).getUserID())) {
                                    ...
                                    if (cUserID != mUID) {
                                        ...
                                        altInitContent += "<div><div class='chat-bubble-right-label'>" + mUser + " (Quản trị viên) - " + mTime + "</div><div class='chat-bubble-right-container'><div class='chat-bubble-right' title='Gửi vào " + mTime + "'>" + tmpMessage + "</div></div></div>";
                                    } else {
                                        altInitContent += "<div><div class='chat-bubble-left-label'>" + mUser + " (Người dùng) - " + mTime + "</div><div class='chat-bubble-left-container'><div class='chat-bubble-left' title='Gửi vào " + mTime + "'>" + tmpMessage + "</div></div></div>";
                                    }
                                } else {
                                    ...
                                    if ((cmList.get(i).getUserID() == cmList.get(i - 1).getUserID()) && (prevOffset <= offsetLimit)) {
                                        ...
                                        if ((cmList.get(i).getUserID() == cmList.get(i + 1).getUserID()) && (nextOffset <= offsetLimit)) {
                                            ...
                                            if (cUserID != mUID) {
                                                // move chat bubble to the right
                                                altInitContent += "<div><div class='chat-bubble-right-label'>" + mUser + " (Quản trị viên) - " + mTime + "</div><div class='chat-bubble-right-container'><div class='chat-bubble-right-top' title='Gửi vào " + mTime + "'>" + tmpMessage + "</div></div></div>";
                                            } else {
                                                altInitContent += "<div><div class='chat-bubble-left-label'>" + mUser + " (Người dùng) - " + mTime + "</div><div class='chat-bubble-left-container'><div class='chat-bubble-left-top' title='Gửi vào " + mTime + "'>" + tmpMessage + "</div></div></div>";
                                            }
                                        } else {
                                            // set as SOLO
                                            if (cUserID != mUID) {
