 ...
 * @author A Hi
 */
@WebServlet(name = "UpdateKanjiPictureControl", urlPatterns = {"/UpdateKanjiPictureControl"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 50, // 50MB
        maxRequestSize = 1024 * 1024 * 50) // 50MB
public class UpdateKanjiPictureControl extends HttpServlet {
...
//        }
        ...
        dao.updateKanjiPicture(a, kanjiID);
