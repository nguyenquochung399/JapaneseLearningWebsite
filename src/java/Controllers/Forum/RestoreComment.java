 ...
 * @author ACER
 */
public class RestoreComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RestoreComment</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RestoreComment at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        restoreComment = request.getParameter("restoreComment");
        if (!restoreComment.equals("")) {
            ...
            int count = CommentDAO.restoreComment2(a);
            //int count2 = ReportNotificationDAO.deleteReportNotificationComment(comment_id);
