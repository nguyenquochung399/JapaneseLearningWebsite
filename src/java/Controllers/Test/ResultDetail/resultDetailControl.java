 ...
 * @author Saing
 */
public class resultDetailControl extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet resultDetailControl</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet resultDetailControl at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
...
//        processRequest(request, response);
        ...
        request.getRequestDispatcher("Test_manage_detailResultDetail.jsp").forward(request, response);
    }
