 ...
 * @author Saing
 */
public class answerCreateControl extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet answerCreateControl</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet answerCreateControl at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
...
//        processRequest(request, response);
        ...
        request.getRequestDispatcher("Test_manage_createAnswer.jsp").forward(request, response);
    }
...
//        processRequest(request, response);
        ...
        dao.insertAnswer(questionID, answer, Integer.valueOf(isCorrect));
