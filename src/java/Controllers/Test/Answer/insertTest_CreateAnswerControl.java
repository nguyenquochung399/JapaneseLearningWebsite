 ...
 * @author Saing
 */
public class insertTest_CreateAnswerControl extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet insertTest_CreateAnswerControl</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet insertTest_CreateAnswerControl at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
