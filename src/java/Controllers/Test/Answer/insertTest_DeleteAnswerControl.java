 ...
 * @author Saing
 */
public class insertTest_DeleteAnswerControl extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet insertTest_DeleteAnswerControl</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet insertTest_DeleteAnswerControl at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
