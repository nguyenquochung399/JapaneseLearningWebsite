 ...
 * @author A Hi
 */
@WebServlet(name = "UpdateAlphabetControl", urlPatterns = {"/UpdateAlphabetControl"})
public class UpdateAlphabetControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.updateAlphabet(type, alphabet, pronounce, alphabetID);
